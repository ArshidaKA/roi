    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        ...
        <button
          ...
          className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-full shadow flex items-center gap-2 transition-colors"
        >
...
<div className="bg-white shadow rounded-2xl overflow-hidden">
  <div className="p-5 bg-blue-50">
    <h2 className="font-semibold text-blue-700 flex items-center gap-2">
      <UserGroupIcon className="w-6 h-6 text-blue-600" /> Registered Staff
    </h2>
  </div>

  <div className="overflow-x-auto">
    <table className="w-full text-sm text-gray-700">
      <thead className="bg-gray-100 text-blue-700 text-xs font-semibold uppercase tracking-wide">
        <tr>
          ...
          <th className="p-4 text-left border-b border-gray-200">Registration Date</th>
        </tr>
      </thead>
      <tbody>
        {data.filter((u) => u.role === "STAFF").length === 0 ? (
          <tr>
            ...
            >
              No staff members registered yet. Click{" "}
              <span className="text-blue-600 font-semibold">"Register New Staff"</span> to get started.
            </td>
          </tr>
        ) : (
          data
